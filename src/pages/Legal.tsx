      ...
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-3xl shadow-sm border border-gray-100">
        ...
        <div className="prose prose-teal max-w-none text-gray-600 space-y-6">
          ...
          <section>
            ...
            <p className="mt-2">
              Los datos no serán cedidos a terceros salvo obligación legal. Tienes derecho a acceder, rectificar y suprimir tus datos en cualquier momento escribiendo a admin.canaryai@gmail.com.
            </p>
          </section>
